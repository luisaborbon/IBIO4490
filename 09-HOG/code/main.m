...
num_negative_examples = 8000; %Higher will work strictly better, but you should start with 10000 for debugging
...
labels  = [ones(size(features_pos,1),1); -1*ones(size(features_neg,1),1)];
[w, b] = vl_svmtrain(train', labels, 0.0001);
